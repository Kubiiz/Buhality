...
<h3>Spēles iestatījumi (% iespējas)</h3>
...
1. Jānokopē un jāpārsauc .env.example fails uz .env
 <pre>cp .env.example .env</pre>
2. Jāizveido jauns Api Key
 <pre>php artisan key:generate</pre>
3. .env failā jāievada datubāzes dati
 <pre>
    DB_CONNECTION=mysql
    DB_HOST=127.0.0.1
    DB_PORT=3306
...
4. Jāmigrē DB tabulas
 <pre>php artisan migrate</pre>
5. Jāpievieno Default DB lietotāju un iestatījumus
