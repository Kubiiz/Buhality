...
@section('content')
    ...
    <div class="counter">
        @foreach($members as $memb)
                <div class="memb_counter"><span id="memb">{{ $memb->name }}</span> - <span class="shots" id="memb_{{ $memb->id }}" class="text-primary">0</span></div>
        @endforeach
    </div>
    ...
    <div class="modal fade" id="stats" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
				...
				<div class="pull-right"><i class="fa fa-glass"></i> Izdzerti <span class="text-primary">{{ $members->sum('shots') }}</span> šoti</div>
